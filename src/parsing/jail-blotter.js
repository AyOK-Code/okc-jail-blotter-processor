...
const regexes = {
  ...
  date: new RegExp('^((?:0?[1-9])|1(?:[0-2]))/((?:0?[1-9])|(?:[1-2][0-9])|(?:3[0-1]))/((?:(?:19)|(?:20))[0-9]{2})$'),
  dateTime: new RegExp('^((?:0?[1-9])|1(?:[0-2]))/((?:0?[1-9])|(?:[1-2][0-9])|(?:3[0-1]))/((?:(?:1[89])|(?:20))[0-9]{2}) ((?:0?[1-9])|(?:1[0-2])):([0-5][0-9]):([0-5][0-9]) ((?:A|P)M)$'),
